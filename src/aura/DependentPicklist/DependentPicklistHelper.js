...
/*    FireOccupationalValuesSelected: function(component, event, helper){
        console.log('FireOccupationalValuesSelected>>StartHere');
        var OccupationalValuesEvent = $A.get("e.c:FireWhenOccupationalValuesAreSelected");
        console.log("FireOccupationalValuesSelected"+OccupationalValuesEvent);
        var Cat = component.find('conCountry').get("v.options");
        var Tit = component.find('conState').get("v.options");
